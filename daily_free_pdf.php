        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1><?= $am['name'] ?>-<?= $year ?></h1>
                    <ul class="breadcrumb">
                        <li><a href="daily_free_pdf.php?id=<?= $pdfid ?>&year=2021" class="btn btn-warning mt-1"></i>View all Daily PDF [2021]</a>
                                &nbsp; &nbsp; <a href="daily_free_pdf.php?id=<?= $pdfid ?>&year=2022" class="btn btn-warning mt-1"></i>View all Daily PDF [2022]</a></div>
							 </li>
