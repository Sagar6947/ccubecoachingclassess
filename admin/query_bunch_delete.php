...
if (isset($_POST['delete'])) {
    ...
    foreach ($_POST['data'] as $value) {
        ...
        $q = mysqli_query($con, "delete from web_query where id='$value'");
    }
...
<head>
    ...
    <title>Ambition | Contact Details</title>
...
<body data-spy="scroll" data-target="#navSection" data-offset="120">
    ...
    <div class="content content-components">
        <div class="container">
            ...
            <h1 class="df-title">Query Details</h1>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-25p">Name/Phone/Email</th>
                        ...
                        <tbody>
                            <?php
                            $x = mysqli_query($con, "select * from `web_query` ");
                            while ($y = mysqli_fetch_array($x)) {
                                echo '<tr>
                                <td>
                                <input name="data[]" value="' . $y['id'] . '" type="checkbox" class="checkb" checked/>
