  ...
  <div class="content content-components">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-2">
          <a href="pdf_bunch_delete.php" class="btn btn-primary">Delete Bunch</a>
        </div>
      </div>
      <div class="container">
        ...
        <div class="df-example demo-forms">
          <form method="post" enctype="multipart/form-data" action="pdf_upload.php" id="form">
            <div class="form-row">
              ...
              <div class="form-group col-md-3 d-none">
                ...
                <select name="month" class="form-control">
                  ...
                  <option <?= ((date('M') == 'Feb') ? 'selected' : '') ?> value='Feb'>Feb</option>
              ...
              <div class="form-group col-md-3">
                <br>
                <a class="btn btn-primary" href="#" id="save">Add PDF</a>
              </div>
            </div>
          </form>
        </div>
      ...
      <div class="df-example demo-table">
        <table id="example2" class="table">
          ...
          <tbody>
            ...
            while ($a = mysqli_fetch_array($b)) {
              $b2 = mysqli_query($con, "select * from `pdf_category` where `id`= '" . $a['subject_id'] . "'");
