...
$qutest = mysqli_query($con, "SELECT * FROM `test_series` WHERE `id` = '".$test_row['t_id']."'");
$test_rw = mysqli_fetch_array($qutest);
// print_r($test_rw);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content content-components">
        <div class="container">
            <div class="row row-xs">
                ...
                <div class="col-sm-2" style="<?= (($test_rw['descriptive'] == '0')? 'display:none':'') ?>">
