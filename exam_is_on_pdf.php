                     ...
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                             <div class="thumb ">
                                 ...
                                 <div class="price"><a href="">'.$r['name'].'</a>
                                 <p>Updated on : '.date_format(date_create($r['date']),'d-m-Y').'</p></div>

                             </div>

                             <div class="info" style="text-align:center">
                             <div style="background-color: white;padding: 5px 4px;">
                                <a href=""admin/'.$r['pdf'].'" class="btn btn-warning"></i>Download PDF</a></div>
							 </div>
