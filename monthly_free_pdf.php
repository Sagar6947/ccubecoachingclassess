            ...
            <div class="row">
                ...
                <div id="Jan" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Jan' AND `year`='" . date('Y') . "' order by id desc ");
                ...
                <div id="Feb" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Feb' AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Mar" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Mar' AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Apr" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Apr' AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="May" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='May'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Jun" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Jun'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Jul" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Jul'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Aug" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Aug'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Sep" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Sep'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Oct" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Oct'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Nov" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Nov'  AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
                ...
                <div id="Dec" class="tabcontent">
                    ...
                    <div class="popular-courses-items">
                        <?php
                        $q = mysqli_query($con, "SELECT * FROM `free_pdf` WHERE `file_type`='".$pdfid."' AND `month`='Dec' AND `year`='" . date('Y') . "' order by id desc ");
                        while ($r = mysqli_fetch_array($q)) {
                            echo '
                     <div class="col-md-3 col-sm-6 equal-height">
                         <div class="item">
