          ...
          <div class="col-lg-12 mg-t-12 mg-lg-t-0">
            <div class="row row-xs">
              ...
              <div class="col-12 col-md-6 col-lg-12">
                <ol>
                <h4 class="mg-b-0 tx-spacing--1">General Instructions:</h4>
                <div class="card card-body">
                   <ol>


                    <li>There will be total	<?= ((isset($_SESSION['questio']))? $_SESSION['questio']:'1') ?>  Questions.</li>
                    <li> Duration will be of	<?= ((isset($_SESSION['duration']))? $_SESSION['duration']:'1') ?>  Minutes. </li>
                ...
                <div class="card card-body">
                    ...
                    <li>In case, if the test does not load completely or becomes unresponsive, click on browser's refresh button to reload</li>
                     	<?= ((isset($_SESSION['descriptive']))? '<li>After MCQ there is discriptive section also</li>':'') ?>
                ...
                <div class="card card-body">
                    ...
                    <li> 	<?= ((isset($_SESSION['positive']))? $_SESSION['positive']:'1') ?> mark(s) will be awarded for each correct answer</li>
                    <li> 	<?= ((isset($_SESSION['negative']))? $_SESSION['negative']:'0.25') ?> mark(s) will be deducted for every wrong answer.</li>
                    <li> 	No marks will be deducted/awarded for un-attempted questions</li>
                     </ol>

                     </div>
                <br>
                <a href="test-panel.php" target="_blank" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"> Start Exam</a>
              </ol>
              </div>
            </div><!-- row -->
          </div><!-- col -->
