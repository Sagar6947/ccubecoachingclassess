           ...
           echo '
            <div class="tab-pane ">
              ...
              <div class="custom-control custom-radio">
                <input type="radio" id="customRadio1'.$r['id'].'" name="customRadio'.$r['id'].'" class="custom-control-input" Checked value="'.$r['option_a'].'">
...
?>
    ...
    $(document).ready(function(){
        $("input[type='radio']").click(function(){
            ...
            var radioValue = $("input[name='customRadio"+ value + "']:checked").val();
            if(radioValue)
            $("#result").append( index + ": " + value + ':'+ radioValue+',');
            });
                   alert("Your are a - ");
        });
    });
